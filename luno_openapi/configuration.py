...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api.luno.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("luno_openapi")
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 1.2.5".format(env=sys.platform, pyversion=sys.version)
        )

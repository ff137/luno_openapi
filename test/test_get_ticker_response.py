...
class TestGetTickerResponse(unittest.IsolatedAsyncioTestCase):
    ...
    def make_instance(self, include_optional) -> GetTickerResponse:
        """Test GetTickerResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetTickerResponse`
        """
        model = GetTickerResponse()
        if include_optional:
    ...
    def testGetTickerResponse(self):
        """Test GetTickerResponse"""
